...
void setup() {
  ...
  // Bitcrusher
  left_BitCrusher.updateCrusher(current_CrushBits,current_SampleRate); //set the crusher to defaults. This will passthrough clean at 16,44100
  right_BitCrusher.updateCrusher(current_CrushBits,current_SampleRate); //set the crusher to defaults. This will passthrough clean at 16,44100
  //Bitcrusher
...
if (button0.fallingEdge()) {
    ...
    left_BitCrusher.updateCrusher(current_CrushBits,current_SampleRate); //current_CrushBits
    right_BitCrusher.updateCrusher(current_CrushBits,current_SampleRate);
